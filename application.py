...
"""the index route with index.html"""
@app.route("/" , methods=["GET", "POST"])
# loginrequired prevents loging in without session[username] and session["channel"] being sent
@login_required
def index():
...
# if username is already taken, will be redirected to sign.html
...
""" initial route for adding a new channel or getting to an existing channel"""
...
""" socket.io route for sending messages"""
